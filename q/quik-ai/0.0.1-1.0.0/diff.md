# Comparing `tmp/quik-ai-0.0.1.tar.gz` & `tmp/quik-ai-1.0.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "quik-ai-0.0.1.tar", last modified: Mon May 29 17:20:39 2023, max compression
+gzip compressed data, was "quik-ai-1.0.0.tar", last modified: Sat Jun 10 03:33:07 2023, max compression
```

## Comparing `quik-ai-0.0.1.tar` & `quik-ai-1.0.0.tar`

### file list

```diff
@@ -1,16 +1,27 @@
-drwxrwxrwx   0        0        0        0 2023-05-29 17:20:39.394008 quik-ai-0.0.1/
--rw-rw-rw-   0        0        0     1087 2023-05-29 14:10:30.000000 quik-ai-0.0.1/LICENSE
--rw-rw-rw-   0        0        0      601 2023-05-29 17:20:39.395004 quik-ai-0.0.1/PKG-INFO
--rw-rw-rw-   0        0        0       73 2023-05-29 17:19:36.000000 quik-ai-0.0.1/README.md
--rw-rw-rw-   0        0        0       97 2023-05-29 14:14:26.000000 quik-ai-0.0.1/pyproject.toml
--rw-rw-rw-   0        0        0      756 2023-05-29 17:20:39.402983 quik-ai-0.0.1/setup.cfg
--rw-rw-rw-   0        0        0      310 2023-05-29 16:59:48.000000 quik-ai-0.0.1/setup.py
-drwxrwxrwx   0        0        0        0 2023-05-29 17:20:39.344964 quik-ai-0.0.1/src/
-drwxrwxrwx   0        0        0        0 2023-05-29 17:20:39.360923 quik-ai-0.0.1/src/quik_ai/
--rw-rw-rw-   0        0        0       56 2023-05-29 14:53:37.000000 quik-ai-0.0.1/src/quik_ai/__init__.py
-drwxrwxrwx   0        0        0        0 2023-05-29 17:20:39.392052 quik-ai-0.0.1/src/quik_ai.egg-info/
--rw-rw-rw-   0        0        0      601 2023-05-29 17:20:39.000000 quik-ai-0.0.1/src/quik_ai.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      249 2023-05-29 17:20:39.000000 quik-ai-0.0.1/src/quik_ai.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-05-29 17:20:39.000000 quik-ai-0.0.1/src/quik_ai.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0      125 2023-05-29 17:20:39.000000 quik-ai-0.0.1/src/quik_ai.egg-info/requires.txt
--rw-rw-rw-   0        0        0        8 2023-05-29 17:20:39.000000 quik-ai-0.0.1/src/quik_ai.egg-info/top_level.txt
...
### Comparing `quik-ai-0.0.1/setup.cfg` & `quik-ai-1.0.0/setup.cfg`
...
-00000150: 652f 7265 6673 2f74 6167 732f 7630 2e30  e/refs/tags/v0.0
...
-000001f0: 0a5b 6f70 7469 6f6e 735d 0d0a 696e 636c  .[options]..incl
-00000200: 7564 655f 7061 636b 6167 655f 6461 7461  ude_package_data
-00000210: 203d 2054 7275 650d 0a70 6163 6b61 6765   = True..package
...
-00000250: 6573 203d 203e 3d33 2e38 0d0a 0d0a 5b6f  es = >=3.8....[o
-00000260: 7074 696f 6e73 2e70 6163 6b61 6765 732e  ptions.packages.
-00000270: 6669 6e64 5d0d 0a77 6865 7265 203d 2073  find]..where = s
-00000280: 7263 0d0a 0d0a 5b6f 7074 696f 6e73 2e70  rc....[options.p
-00000290: 6163 6b61 6765 5f64 6174 615d 0d0a 2a20  ackage_data]..* 
-000002a0: 3d20 2a2e 7478 742c 202a 2e63 7376 2c20  = *.txt, *.csv, 
-000002b0: 2a2e 7062 2c20 2a2e 696e 6465 782c 202a  *.pb, *.index, *
-000002c0: 2e64 6174 612a 0d0a 0d0a 5b65 6767 5f69  .data*....[egg_i
...
+00000200: 7469 6f6e 735d 0d0a 696e 636c 7564 655f  tions]..include_
+00000210: 7061 636b 6167 655f 6461 7461 203d 2054  package_data = T
+00000220: 7275 650d 0a70 6163 6b61 6765 5f64 6972  rue..package_dir
+00000230: 203d 200d 0a09 3d20 7372 630d 0a70 6163   = ...= src..pac
+00000240: 6b61 6765 7320 3d20 6669 6e64 3a0d 0a70  kages = find:..p
+00000250: 7974 686f 6e5f 7265 7175 6972 6573 203d  ython_requires =
+00000260: 203e 3d33 2e38 0d0a 0d0a 5b6f 7074 696f   >=3.8....[optio
...
+000002a0: 6765 5f64 6174 615d 0d0a 2a20 3d20 2a2e  ge_data]..* = *.
+000002b0: 7478 742c 202a 2e63 7376 2c20 2a2e 7062  txt, *.csv, *.pb
+000002c0: 2c20 2a2e 696e 6465 782c 202a 2e64 6174  , *.index, *.dat
+000002d0: 612a 0d0a 0d0a 5b65 6767 5f69 6e66 6f5d  a*....[egg_info]
+000002e0: 0d0a 7461 675f 6275 696c 6420 3d20 0d0a  ..tag_build = ..
+000002f0: 7461 675f 6461 7465 203d 2030 0d0a 0d0a  tag_date = 0....
```
