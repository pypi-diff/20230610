# Comparing `tmp/FLOBOT-0.1.116.tar.gz` & `tmp/FLOBOT-0.1.117.tar.gz`
...
## Comparing `FLOBOT-0.1.116.tar` & `FLOBOT-0.1.117.tar`
...
### Comparing `FLOBOT-0.1.116/FLOBOT/__init__.py` & `FLOBOT-0.1.117/FLOBOT/__init__.py`
...
### Comparing `FLOBOT-0.1.116/setup.py` & `FLOBOT-0.1.117/setup.py`
