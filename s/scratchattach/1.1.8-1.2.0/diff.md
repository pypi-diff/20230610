# Comparing `tmp/scratchattach-1.1.8.tar.gz` & `tmp/scratchattach-1.2.0.tar.gz`
...
### Comparing `scratchattach-1.1.8/scratchattach/_encoder.py` & `scratchattach-1.2.0/scratchattach/_encoder.py`
