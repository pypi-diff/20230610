# Comparing `tmp/scratchattach-1.1.8.tar.gz` & `tmp/scratchattach-1.1.9.tar.gz`
...
### Comparing `scratchattach-1.1.8/scratchattach/_encoder.py` & `scratchattach-1.1.9/scratchattach/_encoder.py`
