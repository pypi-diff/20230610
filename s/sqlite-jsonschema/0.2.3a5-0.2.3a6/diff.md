# Comparing `tmp/sqlite_jsonschema-0.2.3a5-py3-none-win_amd64.whl.zip` & `tmp/sqlite_jsonschema-0.2.3a6-py3-none-win_amd64.whl.zip`
...
+Zip file size: 1560642 bytes, number of entries: 8
+-rw-rw-rw-  2.0 fat        0 b- defN 23-Jun-10 21:31 noop.cp311-win_amd64.pyd
+-rw-rw-rw-  2.0 fat      327 b- defN 23-Jun-10 21:30 sqlite_jsonschema/__init__.py
+-rw-rw-rw-  2.0 fat  3678720 b- defN 23-Jun-10 21:30 sqlite_jsonschema/jsonschema0.dll
+-rw-rw-rw-  2.0 fat       81 b- defN 23-Jun-10 21:30 sqlite_jsonschema/version.py
+-rw-rw-rw-  2.0 fat      545 b- defN 23-Jun-10 21:31 sqlite_jsonschema-0.2.3a6.dist-info/METADATA
+-rw-rw-rw-  2.0 fat      102 b- defN 23-Jun-10 21:31 sqlite_jsonschema-0.2.3a6.dist-info/WHEEL
+-rw-rw-rw-  2.0 fat       23 b- defN 23-Jun-10 21:31 sqlite_jsonschema-0.2.3a6.dist-info/top_level.txt
+-rw-rw-r--  2.0 fat      685 b- defN 23-Jun-10 21:31 sqlite_jsonschema-0.2.3a6.dist-info/RECORD
+8 files, 3680483 bytes uncompressed, 1559432 bytes compressed:  57.6%
```
...
+Filename: sqlite_jsonschema-0.2.3a6.dist-info/METADATA
 Comment: 
 
-Filename: sqlite_jsonschema-0.2.3a5.dist-info/WHEEL
+Filename: sqlite_jsonschema-0.2.3a6.dist-info/WHEEL
 Comment: 
 
-Filename: sqlite_jsonschema-0.2.3a5.dist-info/top_level.txt
+Filename: sqlite_jsonschema-0.2.3a6.dist-info/top_level.txt
 Comment: 
 
-Filename: sqlite_jsonschema-0.2.3a5.dist-info/RECORD
+Filename: sqlite_jsonschema-0.2.3a6.dist-info/RECORD
 Comment: 
...
+Time/Date		Sat Jun 10 21:30:05 2023
 Magic			020b	(PE32+)
...
- 0000000180365570:	0000000180006da0 0000000180006e0b 00000001803198d4
- 000000018036557c:	0000000180006e10 0000000180006eb3 000000018031a150
- 0000000180365588:	0000000180006ec0 0000000180006ee0 000000018031a164
...
+ 0000000180365564:	0000000180006cd0 0000000180006d3b 00000001803198d4
+ 0000000180365570:	0000000180006d40 0000000180006e6f 000000018031a134
+ 000000018036557c:	0000000180006e70 0000000180006ea9 000000018031a148
+ 0000000180365588:	0000000180006eb0 0000000180006ed7 000000018031a154
  ...
  00000001803655dc:	0000000180007860 00000001800078f7 000000018031a2f4
@@ -9336,71 +9336,71 @@
 	  pc+0x06: push rbp
 	User data:
...
- 00000001803198d4 (rva: 003198d4): 0000000180006da0 - 0000000180006e0b
...
+ 00000001803198d4 (rva: 003198d4): 0000000180006cd0 - 0000000180006d3b
 	Version: 1, Flags: none
 	Nbr codes: 4, Prologue size: 0x07, Frame offset: 0x0, Frame reg: none
 	  pc+0x07: alloc small area: rsp = rsp - 0x20
 	  pc+0x03: push rbx
 	  pc+0x02: push rdi
 	  pc+0x01: push rsi
- 000000018031a150 (rva: 0031a150): 0000000180006e10 - 0000000180006eb3
+ 000000018031a134 (rva: 0031a134): 0000000180006d40 - 0000000180006e6f
 	Version: 1, Flags: UNW_FLAG_EHANDLER | UNW_FLAG_UHANDLER
 	Nbr codes: 4, Prologue size: 0x0b, Frame offset: 0x3, Frame reg: rbp
 	  pc+0x0b: FPReg: rbp = rsp + 0x30 (info = 0x0)
 	  pc+0x06: alloc small area: rsp = rsp - 0x38
 	...
 	User data:
-	  000: 70 a1 31 00
- 000000018031a164 (rva: 0031a164): 0000000180006ec0 - 0000000180006ee0
+	  000: 60 a1 31 00
+ 000000018031a148 (rva: 0031a148): 0000000180006e70 - 0000000180006ea9
+	Version: 1, Flags: none
+	Nbr codes: 3, Prologue size: 0x0f, Frame offset: 0x0, Frame reg: none
+	  pc+0x0b: alloc small area: rsp = rsp - 0x28
+	  pc+0x07: push rsi
+	  pc+0x06: push rbp
+ 000000018031a154 (rva: 0031a154): 0000000180006eb0 - 0000000180006ed7
 	Version: 1, Flags: none
 	Nbr codes: 3, Prologue size: 0x0f, Frame offset: 0x0, Frame reg: none
 	  pc+0x0b: alloc small area: rsp = rsp - 0x28
 	  pc+0x07: push rsi
...
-	  020: 00 00 00 00 01 00 00 00 ff ff ff ff c0 6e 00 00
-	  030: 10 6e 00 00 ff ff ff ff 3f 6e 00 00 00 00 00 00
-	  040: 48 6e 00 00 ff ff ff ff
+	  000: 22 05 93 19 02 00 00 00 88 a1 31 00 00 00 00 00
+	  010: 00 00 00 00 04 00 00 00 98 a1 31 00 30 00 00 00
+	  020: 00 00 00 00 01 00 00 00 ff ff ff ff b0 6e 00 00
+	  030: 00 00 00 00 70 6e 00 00 40 6d 00 00 ff ff ff ff
+	  040: 7b 6d 00 00 01 00 00 00 f8 6d 00 00 00 00 00 00
+	  050: fd 6d 00 00 ff ff ff ff
  000000018031a1b8 (rva: 0031a1b8): 0000000180006ee0 - 00000001800071ce
 	Version: 1, Flags: UNW_FLAG_EHANDLER | UNW_FLAG_UHANDLER
...
+(format RSDS signature 90a3d9715dad49b69d4c1cd44a54d941 age 1 pdb D:\a\sqlite-jsonschema\sqlite-jsonschema\target\release\deps\sqlite_jsonschema.pdb)
...
+   180006cd1:	push   %rdi
+   180006cd2:	push   %rbx
+   180006cd3:	sub    $0x20,%rsp
+   180006cd7:	mov    %rdx,%rdi
+   180006cda:	mov    %rcx,%rsi
+   180006cdd:	mov    0x10(%rdx),%rbx
+   180006ce1:	lea    -0x1(%rbx),%rax
+   180006ce5:	and    $0xfffffffffffffff0,%rax
+   180006ce9:	add    %rax,%rcx
+   180006cec:	add    $0x10,%rcx
+   180006cf0:	call   *(%rdx)
+   180006cf2:	cmp    $0xffffffffffffffff,%rsi
+   180006cf6:	je     0x180006d32
+   180006cf8:	lock decq 0x8(%rsi)
+   180006cfd:	jne    0x180006d32
+   180006cff:	mov    0x8(%rdi),%rax
+   180006d03:	cmp    $0x9,%rbx
+   180006d07:	mov    $0x8,%r8d
+   180006d0d:	cmovae %rbx,%r8
+   180006d11:	add    %r8,%rax
+   180006d14:	add    $0xf,%rax
+   180006d18:	mov    %r8,%rdx
+   180006d1b:	neg    %rdx
+   180006d1e:	and    %rax,%rdx
+   180006d21:	je     0x180006d32
+   180006d23:	mov    %rsi,%rcx
+   180006d26:	add    $0x20,%rsp
+   180006d2a:	pop    %rbx
+   180006d2b:	pop    %rdi
    180006d2c:	pop    %rsi
-   180006d2d:	pop    %rbp
...
-   180006da1:	push   %rdi
-   180006da2:	push   %rbx
-   180006da3:	sub    $0x20,%rsp
-   180006da7:	mov    %rdx,%rdi
-   180006daa:	mov    %rcx,%rsi
-   180006dad:	mov    0x10(%rdx),%rbx
-   180006db1:	lea    -0x1(%rbx),%rax
-   180006db5:	and    $0xfffffffffffffff0,%rax
-   180006db9:	add    %rax,%rcx
-   180006dbc:	add    $0x10,%rcx
-   180006dc0:	call   *(%rdx)
-   180006dc2:	cmp    $0xffffffffffffffff,%rsi
-   180006dc6:	je     0x180006e02
-   180006dc8:	lock decq 0x8(%rsi)
-   180006dcd:	jne    0x180006e02
-   180006dcf:	mov    0x8(%rdi),%rax
-   180006dd3:	cmp    $0x9,%rbx
-   180006dd7:	mov    $0x8,%r8d
-   180006ddd:	cmovae %rbx,%r8
-   180006de1:	add    %r8,%rax
-   180006de4:	add    $0xf,%rax
-   180006de8:	mov    %r8,%rdx
-   180006deb:	neg    %rdx
-   180006dee:	and    %rax,%rdx
-   180006df1:	je     0x180006e02
-   180006df3:	mov    %rsi,%rcx
-   180006df6:	add    $0x20,%rsp
-   180006dfa:	pop    %rbx
-   180006dfb:	pop    %rdi
-   180006dfc:	pop    %rsi
-   180006dfd:	jmp    0x180007910
-   180006e02:	nop
-   180006e03:	add    $0x20,%rsp
-   180006e07:	pop    %rbx
-   180006e08:	pop    %rdi
-   180006e09:	pop    %rsi
-   180006e0a:	ret
...
-   180006e10:	push   %rbp
-   180006e11:	push   %rsi
-   180006e12:	sub    $0x38,%rsp
-   180006e16:	lea    0x30(%rsp),%rbp
-   180006e1b:	movq   $0xfffffffffffffffe,0x0(%rbp)
-   180006e23:	mov    (%rcx),%rsi
-   180006e26:	movzbl 0x10(%rsi),%eax
-   180006e2a:	cmp    $0x3,%rax
...
-   180006e61:	jmp    0x180006e76
-   180006e63:	mov    0x18(%rsi),%rdx
-   180006e67:	test   %rdx,%rdx
-   180006e6a:	je     0x180006e7b
-   180006e6c:	mov    0x20(%rsi),%rcx
-   180006e70:	mov    $0x1,%r8d
-   180006e76:	call   0x180007910
-   180006e7b:	cmp    $0xffffffffffffffff,%rsi
-   180006e7f:	je     0x180006eac
-   180006e81:	lock decq 0x8(%rsi)
-   180006e86:	jne    0x180006eac
-   180006e88:	mov    $0x30,%edx
-   180006e8d:	mov    $0x8,%r8d
-   180006e93:	mov    %rsi,%rcx
-   180006e96:	add    $0x38,%rsp
-   180006e9a:	pop    %rsi
-   180006e9b:	pop    %rbp
-   180006e9c:	jmp    0x180007910
-   180006ea1:	call   0x180007400
-   180006ea6:	cmp    $0xffffffffffffffff,%rsi
-   180006eaa:	jne    0x180006e81
-   180006eac:	add    $0x38,%rsp
-   180006eb0:	pop    %rsi
-   180006eb1:	pop    %rbp
-   180006eb2:	ret
-   180006eb3:	data16 data16 data16 cs nopw 0x0(%rax,%rax,1)
-   180006ec0:	mov    %rdx,0x10(%rsp)
-   180006ec5:	push   %rbp
-   180006ec6:	push   %rsi
-   180006ec7:	sub    $0x28,%rsp
-   180006ecb:	lea    0x30(%rdx),%rbp
-   180006ecf:	mov    -0x8(%rbp),%rcx
-   180006ed3:	call   0x180001100
-   180006ed8:	nop
-   180006ed9:	add    $0x28,%rsp
-   180006edd:	pop    %rsi
-   180006ede:	pop    %rbp
-   180006edf:	ret
+   180006d2d:	jmp    0x180007910
+   180006d32:	nop
+   180006d33:	add    $0x20,%rsp
+   180006d37:	pop    %rbx
+   180006d38:	pop    %rdi
+   180006d39:	pop    %rsi
+   180006d3a:	ret
...
+   180006d40:	push   %rbp
+   180006d41:	push   %rsi
+   180006d42:	sub    $0x38,%rsp
+   180006d46:	lea    0x30(%rsp),%rbp
+   180006d4b:	movq   $0xfffffffffffffffe,0x0(%rbp)
+   180006d53:	mov    (%rcx),%rax
+   180006d56:	mov    %rax,-0x8(%rbp)
+   180006d5a:	mov    0x110(%rax),%rcx
+   180006d61:	lock decq (%rcx)
+   180006d65:	jne    0x180006d7f
+   180006d67:	mov    -0x8(%rbp),%rax
+   180006d6b:	lea    0x10(%rax),%rdx
+   180006d6f:	mov    %rdx,-0x10(%rbp)
+   180006d73:	mov    0x118(%rax),%rdx
+   180006d7a:	call   0x180006cd0
+   180006d7f:	mov    -0x8(%rbp),%rsi
+   180006d83:	mov    0x30(%rsi),%r9
+   180006d87:	test   %r9,%r9
+   180006d8a:	je     0x180006dbe
+   180006d8c:	lea    0x1(%r9),%rax
+   180006d90:	mov    $0x18,%ecx
+   180006d95:	mul    %rcx
+   180006d98:	add    $0xf,%rax
+   180006d9c:	and    $0xfffffffffffffff0,%rax
+   180006da0:	add    %rax,%r9
+   180006da3:	add    $0x11,%r9
+   180006da7:	je     0x180006dbe
+   180006da9:	mov    0x48(%rsi),%rcx
+   180006dad:	sub    %rax,%rcx
+   180006db0:	mov    $0x10,%r8d
+   180006db6:	mov    %r9,%rdx
+   180006db9:	call   0x180007910
+   180006dbe:	mov    0x70(%rsi),%rdx
+   180006dc2:	test   %rdx,%rdx
+   180006dc5:	je     0x180006df0
+   180006dc7:	mov    %rdx,%rax
+   180006dca:	shl    $0x5,%rax
+   180006dce:	add    %rax,%rdx
+   180006dd1:	add    $0x31,%rdx
+   180006dd5:	je     0x180006df0
+   180006dd7:	mov    0x88(%rsi),%rcx
+   180006dde:	sub    %rax,%rcx
+   180006de1:	add    $0xffffffffffffffe0,%rcx
+   180006de5:	mov    $0x10,%r8d
+   180006deb:	call   0x180007910
+   180006df0:	lea    0xb0(%rsi),%rcx
+   180006df7:	call   0x1800025f0
+   180006dfc:	mov    -0x8(%rbp),%rsi
+   180006e00:	mov    0xf0(%rsi),%r9
+   180006e07:	test   %r9,%r9
+   180006e0a:	je     0x180006e41
+   180006e0c:	lea    0x1(%r9),%rax
+   180006e10:	mov    $0x18,%ecx
+   180006e15:	mul    %rcx
+   180006e18:	add    $0xf,%rax
+   180006e1c:	and    $0xfffffffffffffff0,%rax
+   180006e20:	add    %rax,%r9
+   180006e23:	add    $0x11,%r9
+   180006e27:	je     0x180006e41
+   180006e29:	mov    0x108(%rsi),%rcx
+   180006e30:	sub    %rax,%rcx
+   180006e33:	mov    $0x10,%r8d
+   180006e39:	mov    %r9,%rdx
+   180006e3c:	call   0x180007910
+   180006e41:	cmp    $0xffffffffffffffff,%rsi
+   180006e45:	je     0x180006e67
+   180006e47:	lock decq 0x8(%rsi)
+   180006e4c:	jne    0x180006e67
+   180006e4e:	mov    $0x128,%edx
+   180006e53:	mov    $0x8,%r8d
+   180006e59:	mov    %rsi,%rcx
+   180006e5c:	add    $0x38,%rsp
+   180006e60:	pop    %rsi
+   180006e61:	pop    %rbp
+   180006e62:	jmp    0x180007910
+   180006e67:	nop
+   180006e68:	add    $0x38,%rsp
+   180006e6c:	pop    %rsi
+   180006e6d:	pop    %rbp
+   180006e6e:	ret
+   180006e6f:	nop
+   180006e70:	mov    %rdx,0x10(%rsp)
+   180006e75:	push   %rbp
+   180006e76:	push   %rsi
+   180006e77:	sub    $0x28,%rsp
+   180006e7b:	lea    0x30(%rdx),%rbp
+   180006e7f:	mov    -0x10(%rbp),%rcx
+   180006e83:	call   0x180006b80
+   180006e88:	mov    -0x8(%rbp),%rsi
+   180006e8c:	lea    0x50(%rsi),%rcx
+   180006e90:	call   0x180006bd0
+   180006e95:	lea    0x90(%rsi),%rcx
+   180006e9c:	call   0x180006bc0
+   180006ea1:	nop
+   180006ea2:	add    $0x28,%rsp
+   180006ea6:	pop    %rsi
+   180006ea7:	pop    %rbp
+   180006ea8:	ret
+   180006ea9:	nopl   0x0(%rax)
+   180006eb0:	mov    %rdx,0x10(%rsp)
+   180006eb5:	push   %rbp
+   180006eb6:	push   %rsi
+   180006eb7:	sub    $0x28,%rsp
+   180006ebb:	lea    0x30(%rdx),%rbp
+   180006ebf:	mov    -0x8(%rbp),%rcx
+   180006ec3:	add    $0xd0,%rcx
+   180006eca:	call   0x180006b80
+   180006ecf:	nop
+   180006ed0:	add    $0x28,%rsp
+   180006ed4:	pop    %rsi
+   180006ed5:	pop    %rbp
+   180006ed6:	ret
+   180006ed7:	int3
...
+   18025d99b:	cs ss add %al,(%rax)
+   18025d99f:	add    %dl,0x18025d9(%rax)
+   18025d9a5:	add    %al,(%rax)
...
+   18025d9f9:	xor    $0x64343137,%eax
+   18025d9fe:	cmp    %sp,0x34(%rbp)
+   18025da02:	gs cmp %ah,%gs:0x34(%rsp,%rsi,1)
+   18025da08:	movsxd (%rdi),%esi
+   18025da0a:	(bad)
+   18025da0b:	xor    %esp,0x30(%rsi)
+   18025da0e:	cmp    %esi,(%rcx)
+   18025da10:	xor    $0x31,%al
+   18025da12:	(bad)
+   18025da14:	cmp    %bh,(%rcx)
+   18025da16:	(bad)
+   18025da17:	movsxd (%rcx),%esi
+   18025da19:	xor    $0x64313338,%eax
+   18025da1e:	xor    -0x7fda2608(%rip),%esi        # 0x1004bb41c
...
+   180318624:	jno    0x1803185ff
+   180318626:	movabs %eax,0x1c4c9d49b65dad90
+   18031862f:	(bad)
+   180318630:	rex.WX push %rsp
+   180318632:	flds   0x1(%rcx)
...
-   18031a19a:	(bad)
-   18031a19b:	inc    %eax
-   18031a19d:	outsb  %ds:(%rsi),(%dx)
-   18031a19e:	add    %al,(%rax)
-   18031a1a0:	adc    %ch,0x0(%rsi)
-   18031a1a3:	add    %bh,%bh
-   18031a1a5:	(bad)
-   18031a1a6:	(bad)
-   18031a1a7:	(bad)
-   18031a1a8:	(bad)
-   18031a1a9:	outsb  %ds:(%rsi),(%dx)
+   18031a193:	add    %dh,0x6e(%rax)
+   18031a196:	add    %al,(%rax)
+   18031a198:	rex insl (%dx),%es:(%rdi)
+   18031a19a:	add    %al,(%rax)
+   18031a19c:	(bad)
+   18031a19d:	(bad)
+   18031a19e:	(bad)
+   18031a19f:	(bad)
+   18031a1a0:	jnp    0x18031a20f
...
-   18031a1b0:	rex.W outsb %ds:(%rsi),(%dx)
+   18031a1b0:	std
+   18031a1b1:	insl   (%dx),%es:(%rdi)
    18031a1b2:	add    %al,(%rax)
    18031a1b4:	(bad)
    18031a1b5:	(bad)
    18031a1b6:	(bad)
    18031a1b7:	lcall  *(%rcx)
...
-   18036556c:	in     (%dx),%al
-   18036556d:	movabs 0x6e0b00006da00031,%al
+   180365564:	shrb   0x0(%rax,%rax,1)
+   180365568:	cmp    0x0(%rbp),%ebp
+   18036556b:	add    %dl,%ah
+   18036556d:	cwtl
+   18036556e:	xor    %eax,(%rax)
+   180365570:	rex insl (%dx),%es:(%rdi)
+   180365572:	add    %al,(%rax)
+   180365574:	outsl  %ds:(%rsi),(%dx)
+   180365575:	outsb  %ds:(%rsi),(%dx)
    180365576:	add    %al,(%rax)
-   180365578:	(bad)
-   180365579:	cwtl
+   180365578:	xor    $0xa1,%al
    18036557a:	xor    %eax,(%rax)
-   18036557c:	adc    %ch,0x0(%rsi)
-   18036557f:	add    %dh,0x5000006e(%rbx)
-   180365585:	movabs 0x6ee000006ec00031,%eax
+   18036557c:	jo     0x1803655ec
+   18036557e:	add    %al,(%rax)
+   180365580:	test   $0x4800006e,%eax
+   180365585:	movabs 0x6ed700006eb00031,%eax
    18036558e:	add    %al,(%rax)
-   180365590:	movabs %fs:0x71ce00006ee00031,%eax
+   180365590:	push   %rsp
+   180365591:	movabs 0x71ce00006ee00031,%eax
    18036559a:	add    %al,(%rax)
    18036559c:	mov    $0xd00031a1,%eax
    1803655a1:	jno    0x1803655a3
    1803655a3:	add    %bh,%ah
    1803655a5:	jno    0x1803655a7
    1803655a7:	add    %dl,%ah
    1803655a9:	movabs 0x73fd000072000031,%eax
```
...
## Comparing `sqlite_jsonschema-0.2.3a5.dist-info/METADATA` & `sqlite_jsonschema-0.2.3a6.dist-info/METADATA`
