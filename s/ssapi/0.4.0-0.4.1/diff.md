# Comparing `tmp/ssapi-0.4.0.tar.gz` & `tmp/ssapi-0.4.1.tar.gz`
...
+gzip compressed data, was "ssapi-0.4.1.tar", last modified: Sat Jun 10 16:54:30 2023, max compression
```

## Comparing `ssapi-0.4.0.tar` & `ssapi-0.4.1.tar`
...
+drwxrwxr-x   0 zedr      (1000) zedr      (1000)        0 2023-06-10 16:54:30.841147 ssapi-0.4.1/
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      143 2023-06-10 16:54:30.840147 ssapi-0.4.1/PKG-INFO
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)       30 2023-06-10 16:26:54.000000 ssapi-0.4.1/pyproject.toml
+drwxrwxr-x   0 zedr      (1000) zedr      (1000)        0 2023-06-10 16:54:30.838147 ssapi-0.4.1/scripts/
+-rwxr-xr-x   0 zedr      (1000) zedr      (1000)      497 2023-04-30 10:24:27.000000 ssapi-0.4.1/scripts/ssapi-web
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)       38 2023-06-10 16:54:30.841147 ssapi-0.4.1/setup.cfg
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      272 2023-06-10 16:54:17.000000 ssapi-0.4.1/setup.py
+drwxrwxr-x   0 zedr      (1000) zedr      (1000)        0 2023-06-10 16:54:30.837147 ssapi-0.4.1/src/
+drwxrwxr-x   0 zedr      (1000) zedr      (1000)        0 2023-06-10 16:54:30.840147 ssapi-0.4.1/src/ssapi/
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)        0 2022-09-17 12:56:21.000000 ssapi-0.4.1/src/ssapi/__init__.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)     3421 2023-06-10 16:51:23.000000 ssapi-0.4.1/src/ssapi/db.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)     1983 2023-06-10 16:51:23.000000 ssapi-0.4.1/src/ssapi/db_utils.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      201 2023-06-10 16:26:54.000000 ssapi-0.4.1/src/ssapi/defaults.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      722 2023-06-10 16:35:56.000000 ssapi-0.4.1/src/ssapi/entities.py
+-rw-r--r--   0 zedr      (1000) zedr      (1000)      631 2023-04-30 11:11:55.000000 ssapi-0.4.1/src/ssapi/env.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      363 2023-06-10 16:26:54.000000 ssapi-0.4.1/src/ssapi/exceptions.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)     2397 2023-06-10 16:26:54.000000 ssapi-0.4.1/src/ssapi/relational.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      826 2023-06-10 16:26:54.000000 ssapi-0.4.1/src/ssapi/types.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)     1038 2023-06-10 16:26:54.000000 ssapi-0.4.1/src/ssapi/utils.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)     2353 2023-06-10 16:51:23.000000 ssapi-0.4.1/src/ssapi/web.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)     1478 2023-06-10 16:53:24.000000 ssapi-0.4.1/src/ssapi/web_decorators.py
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      766 2023-06-10 16:51:21.000000 ssapi-0.4.1/src/ssapi/web_tools.py
+drwxrwxr-x   0 zedr      (1000) zedr      (1000)        0 2023-06-10 16:54:30.840147 ssapi-0.4.1/src/ssapi.egg-info/
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      143 2023-06-10 16:54:30.000000 ssapi-0.4.1/src/ssapi.egg-info/PKG-INFO
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)      480 2023-06-10 16:54:30.000000 ssapi-0.4.1/src/ssapi.egg-info/SOURCES.txt
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)        1 2023-06-10 16:54:30.000000 ssapi-0.4.1/src/ssapi.egg-info/dependency_links.txt
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)       22 2023-06-10 16:54:30.000000 ssapi-0.4.1/src/ssapi.egg-info/requires.txt
+-rw-rw-r--   0 zedr      (1000) zedr      (1000)        6 2023-06-10 16:54:30.000000 ssapi-0.4.1/src/ssapi.egg-info/top_level.txt
```

### Comparing `ssapi-0.4.0/src/ssapi/db.py` & `ssapi-0.4.1/src/ssapi/db.py`
...
### Comparing `ssapi-0.4.0/src/ssapi/db_utils.py` & `ssapi-0.4.1/src/ssapi/db_utils.py`
...
### Comparing `ssapi-0.4.0/src/ssapi/entities.py` & `ssapi-0.4.1/src/ssapi/entities.py`

 * *Files identical despite different names*

### Comparing `ssapi-0.4.0/src/ssapi/env.py` & `ssapi-0.4.1/src/ssapi/env.py`

 * *Files identical despite different names*

### Comparing `ssapi-0.4.0/src/ssapi/relational.py` & `ssapi-0.4.1/src/ssapi/relational.py`

 * *Files identical despite different names*

### Comparing `ssapi-0.4.0/src/ssapi/types.py` & `ssapi-0.4.1/src/ssapi/types.py`

 * *Files identical despite different names*

### Comparing `ssapi-0.4.0/src/ssapi/utils.py` & `ssapi-0.4.1/src/ssapi/utils.py`

 * *Files identical despite different names*

### Comparing `ssapi-0.4.0/src/ssapi/web.py` & `ssapi-0.4.1/src/ssapi/web.py`
...
### Comparing `ssapi-0.4.0/src/ssapi/web_decorators.py` & `ssapi-0.4.1/src/ssapi/web_decorators.py`
...
### Comparing `ssapi-0.4.0/src/ssapi/web_tools.py` & `ssapi-0.4.1/src/ssapi/web_tools.py`
