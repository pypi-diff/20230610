# Comparing `tmp/pyupgrade-3.4.1.tar.gz` & `tmp/pyupgrade-3.5.0.tar.gz`
...
### Comparing `pyupgrade-3.4.1/pyupgrade/_plugins/unittest_aliases.py` & `pyupgrade-3.5.0/pyupgrade/_plugins/unittest_aliases.py`
