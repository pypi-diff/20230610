# Comparing `tmp/pyupgrade-3.5.0.tar.gz` & `tmp/pyupgrade-3.6.0.tar.gz`
...
### Comparing `pyupgrade-3.5.0/pyupgrade/_plugins/typing_pep585.py` & `pyupgrade-3.6.0/pyupgrade/_plugins/typing_pep585.py`
