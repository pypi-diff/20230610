# Comparing `tmp/counterplots-0.0.3.tar.gz` & `tmp/counterplots-0.0.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "counterplots-0.0.3.tar", last modified: Sat Jun 10 19:49:44 2023, max compression
+gzip compressed data, was "counterplots-0.0.4.tar", last modified: Sat Jun 10 20:15:21 2023, max compression
```

## Comparing `counterplots-0.0.3.tar` & `counterplots-0.0.4.tar`

### file list

```diff
@@ -1,27 +1,27 @@
-drwxrwxr-x   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-10 19:49:44.212597 counterplots-0.0.3/
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     1067 2023-06-10 15:01:31.000000 counterplots-0.0.3/LICENSE.txt
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     5712 2023-06-10 19:49:44.212597 counterplots-0.0.3/PKG-INFO
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     5230 2023-06-10 19:13:31.000000 counterplots-0.0.3/README.md
-drwxrwxr-x   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-10 19:49:44.208597 counterplots-0.0.3/counterplots/
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     7742 2023-06-08 13:25:54.000000 counterplots-0.0.3/counterplots/__init__.py
-drwxrwxr-x   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-10 19:49:44.212597 counterplots-0.0.3/counterplots/utils/
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-08 12:29:34.000000 counterplots-0.0.3/counterplots/utils/__init__.py
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)    10947 2023-06-10 12:25:27.000000 counterplots-0.0.3/counterplots/utils/plots.py
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     8868 2023-06-10 12:25:34.000000 counterplots-0.0.3/counterplots/utils/process.py
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     1631 2023-06-10 12:25:46.000000 counterplots-0.0.3/counterplots/utils/verification.py
-drwxrwxr-x   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-10 19:49:44.208597 counterplots-0.0.3/counterplots.egg-info/
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     5712 2023-06-10 19:49:44.000000 counterplots-0.0.3/counterplots.egg-info/PKG-INFO
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)      511 2023-06-10 19:49:44.000000 counterplots-0.0.3/counterplots.egg-info/SOURCES.txt
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)        1 2023-06-10 19:49:44.000000 counterplots-0.0.3/counterplots.egg-info/dependency_links.txt
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)       17 2023-06-10 19:49:44.000000 counterplots-0.0.3/counterplots.egg-info/requires.txt
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)       19 2023-06-10 19:49:44.000000 counterplots-0.0.3/counterplots.egg-info/top_level.txt
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)       38 2023-06-10 19:49:44.212597 counterplots-0.0.3/setup.cfg
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)      931 2023-06-10 19:47:02.000000 counterplots-0.0.3/setup.py
-drwxrwxr-x   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-10 19:49:44.212597 counterplots-0.0.3/tests/
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-08 11:50:57.000000 counterplots-0.0.3/tests/__init__.py
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     4530 2023-06-10 12:29:17.000000 counterplots-0.0.3/tests/test____init__.py
-drwxrwxr-x   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-10 19:49:44.212597 counterplots-0.0.3/tests/utils/
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)        0 2023-06-08 12:24:10.000000 counterplots-0.0.3/tests/utils/__init__.py
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     3095 2023-06-10 12:40:22.000000 counterplots-0.0.3/tests/utils/test_plots.py
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     5550 2023-06-10 12:29:50.000000 counterplots-0.0.3/tests/utils/test_process.py
--rw-rw-r--   0 rmazzine  (1000) rmazzine  (1000)     2868 2023-06-10 12:30:25.000000 counterplots-0.0.3/tests/utils/test_verification.py
...
### Comparing `counterplots-0.0.3/LICENSE.txt` & `counterplots-0.0.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/PKG-INFO` & `counterplots-0.0.4/README.md`
...
### Comparing `counterplots-0.0.3/counterplots/__init__.py` & `counterplots-0.0.4/counterplots/__init__.py`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/counterplots/utils/plots.py` & `counterplots-0.0.4/counterplots/utils/plots.py`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/counterplots/utils/process.py` & `counterplots-0.0.4/counterplots/utils/process.py`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/counterplots/utils/verification.py` & `counterplots-0.0.4/counterplots/utils/verification.py`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/counterplots.egg-info/PKG-INFO` & `counterplots-0.0.4/PKG-INFO`
...
### Comparing `counterplots-0.0.3/setup.py` & `counterplots-0.0.4/setup.py`
...
### Comparing `counterplots-0.0.3/tests/test____init__.py` & `counterplots-0.0.4/tests/test____init__.py`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/tests/utils/test_plots.py` & `counterplots-0.0.4/tests/utils/test_plots.py`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/tests/utils/test_process.py` & `counterplots-0.0.4/tests/utils/test_process.py`

 * *Files identical despite different names*

### Comparing `counterplots-0.0.3/tests/utils/test_verification.py` & `counterplots-0.0.4/tests/utils/test_verification.py`
